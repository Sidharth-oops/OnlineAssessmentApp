...
public class linux_first extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linux_first);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                quiz_timer.purge();
                quiz_timer.cancel();
                startActivity(new Intent(linux_first.this, genre.class));
                finish();
            }
        });

        Retrofit retrofit = new Retrofit.Builder().baseUrl(url).addConverterFactory(GsonConverterFactory.create()).build();
        my_apilinux my_api = retrofit.create(my_apilinux.class);
            ...
            public void onResponse(Call<List<Questions>> call, Response<List<Questions>> response) {
                ...
                next_btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                       ...
                       if(once==false){
                        if (i == data.size()-1) {
                            Intent intent=new Intent(linux_first.this, last_page.class);
                            intent.putExtra("Correct", correctAnswer);
                            intent.putExtra("Genre","LINUX");
                            once=true;
