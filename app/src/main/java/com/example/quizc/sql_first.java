...
public class sql_first extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sql_first);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                quiz_timer.purge();
                quiz_timer.cancel();
                startActivity(new Intent(sql_first.this, genre.class));
                finish();
            }
        });

        Retrofit retrofit = new Retrofit.Builder().baseUrl(url).addConverterFactory(GsonConverterFactory.create()).build();
        my_apisql my_api = retrofit.create(my_apisql.class);
            ...
            public void onResponse(Call<List<Questions>> call, Response<List<Questions>> response) {
                ...
                next_btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(once==false){
                        if (i == data.size()-1) {
                            Intent intent=new Intent(sql_first.this, last_page.class);
                            intent.putExtra("Correct", correctAnswer);
                            intent.putExtra("Genre","SQL");
                            once=true;
